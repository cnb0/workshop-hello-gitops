...
Example project to demonstrate GitOps using [Kustomize](https://github.com/kubernetes-sigs/kustomize), GitHub Actions and giops [ArgoCD](https://github.com/argoproj/argo-cd/)
